 ...
 */
define(['exports', './Cartesian2-08065eec', './Check-be2d5acb', './Transforms-1142ce48', './OrientedBoundingBox-2cc6ca57'], function (n, d, e, l, f) {
	'use strict';
	var t = {},
		i = new d.Cartesian3(),
		x = new d.Cartesian3(),
	...
	function o(n, e, t, r, a) {
		(e = d.Cartesian3.subtract(n, e, i)), (t = d.Cartesian3.dot(t, e)), (e = d.Cartesian3.dot(r, e));
		return d.Cartesian2.fromElements(t, e, a);
	}
	(t.validOutline = function (n) {
		var e = f.OrientedBoundingBox.fromPoints(n, M).halfAxes,
			t = l.Matrix3.getColumn(e, 0, x),
			n = l.Matrix3.getColumn(e, 1, B),
			e = l.Matrix3.getColumn(e, 2, P),
		...
		(t.computeProjectTo2DArguments = function (n, e, t, r) {
			var a,
				...
				m = d.Cartesian3.magnitude(s),
				g = d.Cartesian3.magnitude(c),
				n = d.Cartesian3.magnitude(C),
				u = Math.min(m, g, n);
			return (
				(0 !== m || (0 !== g && 0 !== n)) &&
				(0 !== g || 0 !== n) &&
		...
		(t.createProjectPointsTo2DFunction = function (r, a, i) {
			return function (n) {
				for (var e = new Array(n.length), t = 0; t < n.length; t++) e[t] = o(n[t], r, a, i);
				return e;
			};
		}),
