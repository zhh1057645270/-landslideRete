 ...
 */
define(['exports', './Check-be2d5acb', './when-ad3237a0', './Transforms-1142ce48', './Math-5ca9b250'], function (e, r, C, o, a) {
	'use strict';
	function i(e, r, o) {
		return o < 0 && (o += 1), 1 < o && --o, 6 * o < 1 ? e + 6 * (r - e) * o : 2 * o < 1 ? r : 3 * o < 2 ? e + (r - e) * (2 / 3 - o) * 6 : e;
	}
	function E(e, r, o, t) {
		(this.red = C.defaultValue(e, 1)), (this.green = C.defaultValue(r, 1)), (this.blue = C.defaultValue(o, 1)), (this.alpha = C.defaultValue(t, 1));
	}
	var t, f;
	(E.fromCartesian4 = function (e, r) {
		return C.defined(r) ? ((r.red = e.x), (r.green = e.y), (r.blue = e.z), (r.alpha = e.w), r) : new E(e.x, e.y, e.z, e.w);
	}),
		(E.fromBytes = function (e, r, o, t, f) {
			return (
				...
				C.defined(f) ? ((f.red = e), (f.green = r), (f.blue = o), (f.alpha = t), f) : new E(e, r, o, t)
			);
		}),
		(E.fromAlpha = function (e, r, o) {
			return C.defined(o) ? ((o.red = e.red), (o.green = e.green), (o.blue = e.blue), (o.alpha = r), o) : new E(e.red, e.green, e.blue, r);
		}),
		o.FeatureDetection.supportsTypedArrays() && ((o = new ArrayBuffer(4)), (t = new Uint32Array(o)), (f = new Uint8Array(o))),
		(E.fromRgba = function (e, r) {
			return (t[0] = e), E.fromBytes(f[0], f[1], f[2], f[3], r);
		}),
		(E.fromHsl = function (e, r, o, t, f) {
			(e = C.defaultValue(e, 0) % 1), (r = C.defaultValue(r, 0)), (o = C.defaultValue(o, 0)), (t = C.defaultValue(t, 1));
			var s = o,
				n = o,
				l = o;
			return (
				0 !== r && ((s = i((r = 2 * o - (o = o < 0.5 ? o * (1 + r) : o + r - o * r)), o, e + 1 / 3)), (n = i(r, o, e)), (l = i(r, o, e - 1 / 3))),
				C.defined(f) ? ((f.red = s), (f.green = n), (f.blue = l), (f.alpha = t), f) : new E(s, n, l, t)
			);
		}),
		(E.fromRandom = function (e, r) {
			var o = (e = C.defaultValue(e, C.defaultValue.EMPTY_OBJECT)).red;
			C.defined(o) ||
				((t = C.defaultValue(e.minimumRed, 0)), (f = C.defaultValue(e.maximumRed, 1)), (o = t + a.CesiumMath.nextRandomNumber() * (f - t)));
			var t,
				f = e.green;
			C.defined(f) ||
				((s = C.defaultValue(e.minimumGreen, 0)), (t = C.defaultValue(e.maximumGreen, 1)), (f = s + a.CesiumMath.nextRandomNumber() * (t - s)));
			var s = e.blue;
			C.defined(s) ||
				((n = C.defaultValue(e.minimumBlue, 0)), (l = C.defaultValue(e.maximumBlue, 1)), (s = n + a.CesiumMath.nextRandomNumber() * (l - n)));
			var n,
				l = e.alpha;
			return (
				C.defined(l) ||
					((n = C.defaultValue(e.minimumAlpha, 0)), (e = C.defaultValue(e.maximumAlpha, 1)), (l = n + a.CesiumMath.nextRandomNumber() * (e - n))),
				C.defined(r) ? ((r.red = o), (r.green = f), (r.blue = s), (r.alpha = l), r) : new E(o, f, s, l)
			);
		});
	...
	(E.fromCssColorString = function (e, r) {
		...
		return null !== o
			...
			? ((r.red = parseFloat(o[1]) / ('%' === o[1].substr(-1) ? 100 : 255)),
			  ...
			  r)
			: null !== (o = u.exec(e))
			? E.fromHsl(parseFloat(o[1]) / 360, parseFloat(o[2]) / 100, parseFloat(o[3]) / 100, parseFloat(C.defaultValue(o[4], '1.0')), r)
			: (r = void 0);
	}),
		(E.packedLength = 4),
		(E.pack = function (e, r, o) {
			return (o = C.defaultValue(o, 0)), (r[o++] = e.red), (r[o++] = e.green), (r[o++] = e.blue), (r[o] = e.alpha), r;
		}),
		(E.unpack = function (e, r, o) {
			return (r = C.defaultValue(r, 0)), ((o = !C.defined(o) ? new E() : o).red = e[r++]), (o.green = e[r++]), (o.blue = e[r++]), (o.alpha = e[r]), o;
		}),
		...
		(E.equals = function (e, r) {
			return e === r || (C.defined(e) && C.defined(r) && e.red === r.red && e.green === r.green && e.blue === r.blue && e.alpha === r.alpha);
		}),
		...
		(E.prototype.toCssHexString = function () {
			...
			if ((o.length < 2 && (o = '0' + o), this.alpha < 1)) {
				...
				return '#' + e + r + o + (t = t.length < 2 ? '0' + t : t);
			}
			return '#' + e + r + o;
		}),
		(E.prototype.toBytes = function (e) {
			...
			return C.defined(e) ? ((e[0] = r), (e[1] = o), (e[2] = t), (e[3] = f), e) : [r, o, t, f];
		}),
		...
		(E.prototype.darken = function (e, r) {
			return (r.red = this.red * (e = 1 - e)), (r.green = this.green * e), (r.blue = this.blue * e), (r.alpha = this.alpha), r;
		}),
