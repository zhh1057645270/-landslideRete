 ...
 */
define(['exports', './Cartesian2-08065eec', './Check-be2d5acb', './when-ad3237a0', './Math-5ca9b250'], function (t, a, o, u, c) {
	'use strict';
	var i = {
			octEncodeInRange: function (t, o, e) {
				...
				return (
					...
					t.z < 0 &&
						((n = e.x), (t = e.y), (e.x = (1 - Math.abs(t)) * c.CesiumMath.signNotZero(n)), (e.y = (1 - Math.abs(n)) * c.CesiumMath.signNotZero(t))),
	...
	(i.octEncodeToCartesian4 = function (t, o) {
		...
		(i.octDecodeInRange = function (t, o, e, n) {
			return (
				...
				n.z < 0 && ((e = n.x), (n.x = (1 - Math.abs(n.y)) * c.CesiumMath.signNotZero(e)), (n.y = (1 - Math.abs(e)) * c.CesiumMath.signNotZero(n.y))),
		...
		(i.octDecodeFromCartesian4 = function (t, o) {
			var e = t.x,
				...
				a = t.z,
				t = t.w;
			return i.octDecodeInRange(256 * e + n, 256 * a + t, 65535, o);
		}),
		(i.octPackFloat = function (t) {
			return 256 * t.x + t.y;
		});
	var s = new a.Cartesian2();
	function d(t) {
		return (t >> 1) ^ -(1 & t);
	}
	(i.octEncodeFloat = function (t) {
		...
		(i.octDecodeFloat = function (t, o) {
			var e = t / 256,
				t = Math.floor(e);
			return i.octDecode(t, 256 * (e - t), o);
		}),
		(i.octPack = function (t, o, e, n) {
			(t = i.octEncodeFloat(t)), (o = i.octEncodeFloat(o)), (e = i.octEncode(e, s));
